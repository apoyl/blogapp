...
{
    if (!_textField) {
        _textField = [[UITextField alloc]initWithFrame:CGRectMake(10, 10, 250, 44)];
...
//        [_sendBtn setBackgroundColor:[UIColor whiteColor]];
        [_sendBtn setFrame:CGRectMake(270, 20, 40, 24)];
...
-(void)sendBtnPress:(UIButton*)sender
{
    ...
    if (![self.textField.text isEqual:@""] && self.resignFirstResponderWhenSend) {
...
{
    LYCAppDelegate *appDelegate = (LYCAppDelegate*)[UIApplication sharedApplication].delegate;
